...
def main():
    ...
    parser.add_argument('--video', default='5.mp4', help='Video file or webcam id')
    ...
    parser.add_argument(
        '--show', action='store_true', default=True, help='Whether to show draw result')
    parser.add_argument(
        '--show-wait-time', default=1, type=int, help='Wait time after imshow')
    parser.add_argument(
        '--output-file', default='test5.mp4', type=str, help='Output video file path')
    parser.add_argument(
        '--output-fourcc',
        default='mp4v',
        type=str,
